System.register(['angular2/core', './generator.service.ts', './math.service.ts', './drawer.service.ts', './options.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, core_2, generator_service_ts_1, math_service_ts_1, drawer_service_ts_1, options_component_1;
    var CanvasComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            CanvasComponent = (function () {
                ...
                CanvasComponent = __decorate([
                    core_1.Component({
                        selector: 'my-canvas',
                        templateUrl: 'app/app.canvas.html',
                        providers: [generator_service_ts_1.Generator2DService, math_service_ts_1.MathService, drawer_service_ts_1.DrawerService],
